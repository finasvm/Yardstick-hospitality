!(function (t, e) {
	...
	function s(t) {
		...
		(P.style.transition = P.style.webkitTransition =
			'fadeIn' === j.animation ? 'opacity .4s ease' : 'slideIn' === j.animation ? '' : 'none'),
	...
	function m(t, e) {
		...
		if ('undefined' != typeof n) {
			...
			var o = R[t].imageElement,
				...
				a =
					'function' == typeof j.captions ? j.captions.call(R, o) : o.getAttribute('data-caption') || o.title,
				r = b(o),
				l = N('figure');
			if (
	...
	function y() {
		...
		'fadeIn' === j.animation
			? ((P.style.opacity = 0),
			  setTimeout(function () {
					M.transforms
						? (P.style.transform = P.style.webkitTransform = 'translate3d(' + t + ',0,0)')
						: (P.style.left = t),
						(P.style.opacity = 1);
			  }, 400))
			: M.transforms
	...
	function w() {
		var t = N('div');
		return (
			(t.innerHTML = '<svg/>'), 'http://www.w3.org/2000/svg' === (t.firstChild && t.firstChild.namespaceURI)
		);
	}
	function x(t) {
		t - z >= j.preload ||
